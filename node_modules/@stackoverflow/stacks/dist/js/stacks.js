    ...
    focusInsideModal() {
        this.modalTarget.addEventListener("s-modal:shown", () => {
            ...
            if (!this.modalTarget.contains(document.activeElement)) {
                const initialFocus = (_b = (_a = this.firstVisible(this.initialFocusTargets)) !== null && _a !== void 0 ? _a : this.firstVisible(this.getAllTabbables())) !== null && _b !== void 0 ? _b : this.modalTarget; //If there's nothing else, focus the modal itself
                initialFocus.focus();
            }
        }, { once: true });
    }
...
class BasePopoverController extends StacksController {
    ...
    get shouldHideOnFocusLeave() {
        var _a, _b;
        return (this.shouldHideOnOutsideClick &&
            (((_a = this.popoverElement) === null || _a === void 0 ? void 0 : _a.getAttribute("role")) === "menu" ||
                !!((_b = this.popoverElement) === null || _b === void 0 ? void 0 : _b.querySelector('[role="menu"]'))));
    }
    /**
...
class PopoverController extends BasePopoverController {
    ...
    bindDocumentEvents() {
        ...
        this.referenceElement.addEventListener("focusout", this.boundHideOnFocusOut);
        this.popoverElement.addEventListener("focusout", this.boundHideOnFocusOut);
    }
    /**
     * Unbinds global events to the document for hiding popovers on user interaction
     */
    unbindDocumentEvents() {
        ...
        this.referenceElement.removeEventListener("focusout", this.boundHideOnFocusOut);
        this.popoverElement.removeEventListener("focusout", this.boundHideOnFocusOut);
    }
    /**
     * Forces the popover to hide if a user clicks outside of it or its reference element
